...
if __name__ == '__main__':
    ...
    # if we only keep migrants. uncomment the line below
    # users = users[users.type.isin([1, 2, 5])]
    ...
    dest.columns = ['user', 'if_move', 'd_dest', 'l_dest', 's_dest',
    ...
    dest_home.to_csv('data/dest_home_d_s_l.csv', index=None)